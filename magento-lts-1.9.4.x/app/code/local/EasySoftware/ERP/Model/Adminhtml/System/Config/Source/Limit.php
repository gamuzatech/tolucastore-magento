...
class EasySoftware_ERP_Model_Adminhtml_System_Config_Source_Limit
{
    ...
    {
        $result = array(
            EasySoftware_ERP_Helper_Data::QUEUE_LIMIT_30  => Mage::helper ('erp')->__('30 items'),
            EasySoftware_ERP_Helper_Data::QUEUE_LIMIT_60  => Mage::helper ('erp')->__('60 items'),
            EasySoftware_ERP_Helper_Data::QUEUE_LIMIT_90  => Mage::helper ('erp')->__('90 items'),
            EasySoftware_ERP_Helper_Data::QUEUE_LIMIT_120 => Mage::helper ('erp')->__('120 items'),
            EasySoftware_ERP_Helper_Data::QUEUE_LIMIT_150 => Mage::helper ('erp')->__('150 items'),
            EasySoftware_ERP_Helper_Data::QUEUE_LIMIT_180 => Mage::helper ('erp')->__('180 items'),
            EasySoftware_ERP_Helper_Data::QUEUE_LIMIT_210 => Mage::helper ('erp')->__('210 items'),
            EasySoftware_ERP_Helper_Data::QUEUE_LIMIT_240 => Mage::helper ('erp')->__('240 items'),
            EasySoftware_ERP_Helper_Data::QUEUE_LIMIT_270 => Mage::helper ('erp')->__('270 items'),
